...
const tips = [
  {
    ...
    title: "Документы",
    items: [
      "Паспорт (для внутренних рейсов)",
      "Загранпаспорт (для некоторых регионов)",
      "Страховой полис",
      "Бронирования отелей и билеты",
    ],
  },
  {
    icon: Luggage,
  ...
  },
  {
    ...
    items: [
      ...
      "Наличные для малых городов",
      "СБП работает повсеместно",
  ...
  },
  {
    ...
    title: "Связь",
    items: [
      "Мобильная связь почти везде",
      "На Камчатке и Алтае — перебои",
      "Wi-Fi в отелях и кафе",
  ...
  },
  {
    ...
    items: [
      "Оформите страховку",
      "Держите копии документов отдельно",
      "Сообщайте близким о маршруте",
      "Следуйте рекомендациям гида",
    ],
  },
];
